...
import { getClient, getClients, addClient } from "../../redux/actions";
...
const mapStateToProps = state => {
  const { clients, client, clientAdded, loading, error } = state.User;
  return { clients, clientAdded, loading, error };
};

export default connect(
  mapStateToProps,
  { getClients, getClient, addClient }
)(Add);
